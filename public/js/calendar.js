...
!function() {
  var data = [
    ...
    { eventName: 'Stress-relieving - 3', calendar: 'Stress-relieving', color: 'orange' },
    { eventName: 'Stress-relieving - 4', calendar: 'Stress-relieving', color: 'orange' },

    { eventName: 'Relaxing - 1', calendar: 'Relaxing', color: 'blue' },
    { eventName: 'Relaxing - 2', calendar: 'Relaxing', color: 'blue' },
    { eventName: 'Relaxing - 3', calendar: 'Relaxing', color: 'blue' },
    { eventName: 'Relaxing - 4', calendar: 'Relaxing', color: 'blue' },

    { eventName: 'Productive - 1', calendar: 'Productive', color: 'yellow' },
    { eventName: 'Productive - 2', calendar: 'Productive', color: 'yellow' },
